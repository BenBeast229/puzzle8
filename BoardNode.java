...
public class BoardNode {
	// This class constructs and contains all the information for each parents and children node
	// It also uses other variables to determine the position of a node, the direction it has to go in, and the cost
